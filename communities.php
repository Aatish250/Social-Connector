...
<main class="flex-1 flex ml-20 lg:ml-64 h-screen overflow-hidden">
    ...
    <section class="w-24 md:w-96 surface-container-low flex flex-col h-full border-r border-outline-variant/10">
        <div class="p-6">
            ...
            <div class="-mx-5 md:mx-0 relative mt-4">
                ...
                <input
                    ...
                    placeholder="Search communities..." type="text" />
            </div>
        </div>
        <div class="flex-1 overflow-y-auto no-scrollbar px-2 space-y-1 pb-6">
            ...
            <!-- Active Item -->
            <div
                class="p-4 bg-secondary-container rounded-2xl relative flex items-center gap-4 cursor-pointer transition-all duration-300 group">
                <div
                    class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-10 bg-primary rounded-r-full shadow-[0_0_8px_#ac8aff]">
                </div>
                <div
                    class="w-12 h-12 rounded-xl bg-primary-container flex items-center justify-center text-on-primary-container overflow-hidden flex-shrink-0">
                    <img alt="Design Community Icon" class="w-full h-full object-cover"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuB1Hp93LUNvO1kl_a8p3Y_eJZEo2-OXX3UgTusBMMLIzSRDxS1eHtwInKw3GeVK15To3xll9ym8WxP7nFT_t2iBnPoutuKpjOaeAGXJrlwSA3VjRuwqfIZhklG0MzTHlyceeAMn9H-WO4y0ArGeYxArUoo9TBump03l1sn-A0Fd9Agzuidq8K5J9sqTSTeyD68PnYbve-Wb8N_4F0wWwAJp9_l4l9DBpK1jTKgOKxhbs7fuzj4Ffpf1wmnqNPvGvcmhVzYe8j99Sw" />
                </div>
            ...
            <div
                ...
                <div
                    class="w-12 h-12 rounded-xl bg-surface-container-highest flex items-center justify-center overflow-hidden flex-shrink-0">
                    <img alt="Tech Hub Icon" class="w-full h-full object-cover"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuBlv1K4E_NORjbVpVl6RFsGQHtub0dxVuugh3Zs-6kYNWBqf3tHTtN90xr_jFaGtd9JFQQIwc9Pf8z_3gCHQJwXDGR27K8nZRf3RAVOODG-koNdlKSG1dq7D8yfgmu-9uNjnvlLmFw6d8mLOqM96NVCQJNdvZHpkD_3lcpMdJQsQYEaIszSwuvSiOrN-DBb60FWq7n7MVGkewuvQKM8pdsO1rZF1uWCnHGTZ-SZL1kDonxnCClRmmdWY8jkkPXH52NR3g0xx0Oxkg" />
                </div>
                <div class="flex-1 min-w-0 hidden md:block">
                    <div class="flex justify-between items-baseline mb-0.5">
            ...
            <div
                ...
                <div
                    class="w-12 h-12 rounded-xl bg-surface-container-highest flex items-center justify-center overflow-hidden flex-shrink-0">
                    <img alt="Marketing Masters Icon" class="w-full h-full object-cover"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuC2hVbk4z0d3akGp5XnHVvocATovwN6nEVPgosIenDiQgSJoYcmi-ZMSb-mEHPgBLv7D3_dKFjt3OR82W_P_fitFnSMEsHoHefgGYXH2KzD2sI7ZB9eQZjdm2Wu39ev8s0k9YJb9XHBbyrx6emi7L1Wy0_axXosJ9MBZdOLijBpKkhn7PUvBSgRLf4rAytyuOFTBSrQC_7frpO44wjqXl8-ig8CgGuRP7NAcOulFZJLvGfyDVjTDNY0G0MZZF6XrVKw7RG6GHVhGg" />
                </div>
                <div class="flex-1 min-w-0 hidden md:block">
                    <div class="flex justify-between items-baseline mb-0.5">
            ...
            <div
                ...
                <div
                    class="w-12 h-12 rounded-xl bg-surface-container-highest flex items-center justify-center overflow-hidden flex-shrink-0">
                    <img alt="Code Warriors Icon" class="w-full h-full object-cover"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuAV_G8M8_p6z9g7R1Hnaq7l78GjpzibxmYAIMBEikcI5mN0aEqidwH0JLB1Ob_qSVAAyBvVR1rzpwERRos1xHTBtIP1gMcPjMFxrULwcGIJ6Wi69L3K6Qm1_zmRwk7tKVEx6ziDBwYJhTiVeoHpageFYtOne_QdCfhXTax2kS8hHkofcDfS8Hhq5WuZ8o0C1Bj84Y2td4J_XEHXmpzkaQyEFg2c_urfqFpmjL-488vlInibHzkPxZPzfIf-F_jtTXBS2huHvI9mPA" />
                </div>
                <div class="flex-1 min-w-0 hidden md:block">
                    <div class="flex justify-between items-baseline mb-0.5">
    ...
    <section class="flex-1 bg-surface-variant flex flex-col h-full relative">
        ...
        <header class="h-20 flex items-center px-8 bg-surface-container-low/50 backdrop-blur-md sticky top-0 z-30">
            <div class="flex items-center gap-4">
                <div
                    class="w-10 h-10 rounded-lg bg-primary-container flex items-center justify-center font-bold text-on-primary-container">
                    DC</div>
                <div>
        ...
        <div class="flex-1 overflow-y-auto p-8 flex flex-col gap-8 no-scrollbar">
            ...
            <div class="flex items-end gap-3 max-w-[80%]">
                <img alt="User Avatar" class="w-8 h-8 rounded-full object-cover flex-shrink-0"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuC4r_AbA4Qg0KPY1ThqiZG_ZA1ere4DBqZ9HP_Aw6eMaaBnMRvyzH81N5CYaI3gRN5vMRpf-CCMj1dOq_G1AcxFvFuTeEuJ0AsQHa0g0C6Bcy2uNT0t6A8bAb0LbrbJ7Gp3qd9shzgoQdWqd1rVvHnMAThTTgkoR9KTLGyeFIFW_92pNHelEtrAV49Msfqruvi7WfQrzcwAPmuoTrBiFTUjZno-3byiJP-d_xX8Z8TkU4_fkjoPawYqJLT0hOD2Ajj9nfjxMuH1IA" />
                <div class="flex flex-col gap-1">
                    <div
                        class="bg-surface-container-high text-on-surface p-4 rounded-t-2xl rounded-br-2xl rounded-bl-sm shadow-sm">
                        <p class="text-sm leading-relaxed"><span class="font-bold mr-1">Elena Rodriguez</span>Hey
                            everyone! Just uploaded the new design system proposal. Would love to get some feedback on
                            the nocturnal theme tokens. 🌙</p>
                    </div>
            ...
            <div class="flex items-end gap-3 max-w-[80%] self-end flex-row-reverse">
                <div class="flex flex-col items-end gap-1">
                    <div
                        ...
                        <p class="text-sm leading-relaxed">Checking it out now Elena! The tonal shifts look incredibly
                            smooth. The purple glow on active states is a nice touch.</p>
                    </div>
            ...
            <div class="flex items-end gap-3 max-w-[80%]">
                <img alt="User Avatar" class="w-8 h-8 rounded-full object-cover flex-shrink-0"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuAKyBsveQUo4ACDJjRCcOd2zckJkhqqOAJTlDfx89_ZbM3q3ZPtqBMIY3OKKQPjDdiqq_hPO2d1yu0Ln1QNkBp8HNhQTK61us2Vx1s0GtWlZglCtKCirRvyBaU_s4bATSxfDYUMBfRCefCePmBPTGc12LaUGrwdP3TmFOUKAEaWpNHb6TAB7F1etEb2CNg86l6s5GnywMN71MTjeSYtVd87YRUGUxgVHUHenmxLKu5r0i8wJc3_xhIE4C2_v7S23BoC6uZyTQRHIQ" />
                <div class="flex flex-col gap-1">
                    <div
                        class="bg-surface-container-high text-on-surface p-4 rounded-t-2xl rounded-br-2xl rounded-bl-sm shadow-sm">
                        <p class="text-sm leading-relaxed"><span class="font-bold mr-1">Alex Chen</span>Agreed. I
                            particularly like the "No-Line" rule implementation. It makes the interface feel much more
                            like a high-end physical space.</p>
                    </div>
            ...
            <div class="max-w-4xl mx-auto relative flex items-center gap-3">
                <div
                    ...
                    <input
                        ...
                        placeholder="Message #Design-Community" type="text" />
                </div>
                <button
